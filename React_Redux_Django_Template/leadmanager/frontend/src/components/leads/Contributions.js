...
export class Contributions extends Component{
    render(){
        return(
            ...
            <body>
            <p>
                Here lies the credit due to all who worked on this project. 
                The time spent in agonizing pain, or joyful relief!<br></br>
            ...
            <p>
                ...
                <p>
                As for our work on the Frontend, the Team and I all contributed to each of the 
                pages associated on the system and I, Chase, took the time to handle the framework
                and all the extra pages coalligned with our project.
                </p>
