  ...
  render() {
    return (
      <div>
        <h2>Dashboard</h2>
        <img
          src="/static/frontend/resources/Brain.png"
          width="250"
          height="210"
        ></img>
        <h5>
          Welcome to the DementiaTrack Web Application. Click one of the links
          below to head to the symptom you wish to analyze of the patient, or
        ...
        <ul>
          ...
          <li>
            <a href="#/uti">Urinary Tract Infection</a>
          </li>
          <li>
        ...
        <h6>
          Information about the contributors and the references can be found
          below at the bottom of the page. With that if you have any problems
