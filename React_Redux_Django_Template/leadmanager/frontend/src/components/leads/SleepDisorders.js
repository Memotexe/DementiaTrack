...
export class SleepDisorders extends Component {
    ...
    return (
      <div id="page">
        <h1 id="title"><b>Sleep Disorders</b></h1>
...
class Overview extends React.Component {
  render() {
    return (
    <div id="overview">
        <h2><b>Purpose Statement</b></h2>
        <hr style={{ backgroundColor: "#6699CC" }} />
        <p>The purpose of this page is to utilize algorithms used to detect the stages of sleep to identify if the patient is showing issues in their sleep
        schedule. A sleep schedule of a patient gives a picture into how the patient's brain is able to recover in sleep. If issues in sleep arise
         issues in the brain may also arise showing signs of diseases like Dementia.</p>
  ...
  render() {
    return (
      <div id="set">
        ...
        min="1990-01-01" max="2020-12-31"></input>
        <br></br>
        <h5>
            End Date:
        </h5>
        <input type="date" id="end" name="ending-date"
        min="1990-01-01" max="2020-12-31"></input>
        <br></br>
        <br></br>
