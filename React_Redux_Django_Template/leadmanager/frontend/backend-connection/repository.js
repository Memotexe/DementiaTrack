...
class Repository {
  ...
  async GetLocationOccurences(dataTypeToRun) {
    ...
    let response = await api.get(
      "database/move?dataTypeToRun=" + dataTypeToRun
    );
  ...
  async testBackendConnection(start, end) {
    ...
    let response = await api.get(
      "database/test?startdate=" + start + "&&enddate=" + end
    );
  ...
  async GetSleepSelect(dataTypeToRun) {
    ...
    let response = await api.get(
      "database/sleepSelect?dataTypeToRun=" + dataTypeToRun
    );
